...
def entrega_cadastrar():
    if request.method == 'POST':
        ...
        rota_media.total_de_entregas = quantidade_de_entregas + rota_media.total_de_entregas
...
def deletar_entrega(entrega_id):
    ...
    rota_media.tempo_medio_rota = recalcularMediaRota(nova_media)
    rota_media.total_de_entregas = entrega.quantidade_de_entregas - rota_media.total_de_entregas
